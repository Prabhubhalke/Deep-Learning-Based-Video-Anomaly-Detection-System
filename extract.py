...
# Add "data/" prefix to video names since videos are stored in the data directory
train_df["video_name"] = "data/" + train_df["video_name"]
test_df["video_name"] = "data/" + test_df["video_name"]
